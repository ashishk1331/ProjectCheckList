...
function parser(block){
	...
	switch(block.type){
		...
		case 'image':
			return <>
			 	<div className="w-full h-fit border-2 rounded flex mt-12 mb-2" key={block.id}>
					<Image 
				...
				<p key={block.id + 'caption'} className="mb-12 mx-auto w-fit text-gray-600 italic" >fig. {block[block.type].caption[0].plain_text}</p>
			</>
